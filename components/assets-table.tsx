...
export function AssetsTable() {
  ...
  return (
    <div className="rounded-2xl border border-[color:var(--color-line)] bg-[color:var(--color-paper)] overflow-hidden">
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 px-4 sm:px-5 py-3.5 border-b border-[color:var(--color-line)] bg-[color:var(--color-cream-soft)]">
        ...
        <div className="relative flex-1 sm:flex-none">
          ...
          <input
            ...
            className="h-9 w-full sm:w-[280px] pl-9 pr-3 rounded-lg border border-[color:var(--color-line-strong)] bg-[color:var(--color-paper)] text-[12.5px] text-[color:var(--color-ink-strong)] placeholder:text-[color:var(--color-ink-faint)] focus:outline-none focus:border-[color:var(--color-sycamore)]/50 focus:ring-2 focus:ring-[color:var(--color-sycamore)]/15 transition-colors"
          />
        </div>
